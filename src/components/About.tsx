...
const About = () => {
  return (
    <div className="text-black">
      <h1 className="flex justify-center bg-gradient-to-r from-[#324958] to-[#583249] dark:from-[#71fead] dark:to-[#437e60] bg-clip-text pt-20 font-bold text-transparent md:-mb-10">
        About
      </h1>
      <section className="flex text-sm md:pt-10 h-full w-full flex-col items-center md:mx-auto md:h-1/2 md:w-2/3 md:flex-row md:px-10 lg:flex-row">
        <Image
          src={gradPic}
          alt="about me pic"
          className="-mb-2 h-3/4 w-1/2 rounded-full border-2 border-[#000000] dark:border-[#71fead] drop-shadow-sm md:mb-0 md:mr-2 md:h-auto md:w-60 md:p-[0.5px]"
        />
        <div className="flex h-auto w-full flex-col justify-start px-4 pt-4 align-middle dark:text-white  md:h-auto md:w-full">
          <div className="flex w-full items-center justify-start pb-4">
            <div className="mt-2 flex flex-col md:mt-0">
              <h3 className="items-start justify-center sm:flex-row">
                Hello, my name is&nbsp;
                <span className="bg-gradient-to-r from-[#324958] to-[#583249] dark:from-[#71fead] dark:to-[#437e60] bg-clip-text font-bold text-transparent">
          ...
          <div className="bg-gradient-to-r from-[#324958] to-[#583249] dark:from-[#71fead] dark:to-[#437e60] p-0.5 dark:border-slate-200"></div>
          <div className="flex items-center pl-1 pt-4 font-thin">
            <CiLocationOn className="text-2xl text-[#583249] dark:text-[#71fead]" />
            <h3 className="my-auto pl-1 text-sm md:text-base font-light tracking-wide">
              McAllen, TX
            </h3>
          </div>
          <div className="flex items-center pl-2 text-lg">
            <HiOutlineMail className="text-[#583249] dark:text-[#71fead]" />
